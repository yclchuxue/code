...
/* 如输入命令为“ls -al /tmp”，则arglist[0], arglist[1], arglist[2]分别为ls ，-1和/tmp */
...
void do_cmd(int argcount, char arglist[100][256])
{
    ...
    /* flag大于1, 说明命令中含有多个>, <, |符号， 本程序是不支持这样的命令的。或者命令格式不太对，如“ls -l/tmp >" */
    ...
    {
        /* 命令只含有一个输入重定向符号 */
        /* 把管道符号后门的部分存入argnext中， 管道后面的部分是执行的shell命令 */
